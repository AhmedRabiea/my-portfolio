              ...
              <div className="flex items-center justify-between mt-7 mb-3">
                <div className="flex items-center">
                  {iconLists.map((icon, index) => (
                    <div
                      key={icon}
                      className="border border-white/[0.2] w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-black flex items-center justify-center"
                ...
                <div className="flex items-center justify-center">
                  ...
                  <MdArrowOutward className="ms-2" color="#CBACF9" />
                </div>
              </div>
            </PinContainer>
          </div>
