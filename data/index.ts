...
export const projects = [
  {
    ...
    des: "Almotarjim is a comprehensive translation platform offering high-quality language services with all documentation and customer care via the platform using React.js.",
    img: "/project1.svg",
  ...
  {
    id: 3,
    title: "Roayah Software Solutions",
    des: "A software house platform that make it easy for clients to get in touch with their team using Next.js.",
    img: "/project3.png",
  ...
  },
  {
    id: 4,
    title: "Fastum ",
    des: "Medical product wchich advertinsing with the fatum platform and tech clients more about its effect using Next.js.",
    img: "/project4.png",
